Know Your Fan é uma aplicação web desenvolvida com Streamlit que permite o cadastro e análise de fãs da organização FURIA, utilizando validação documental por OCR e integração com a API do Twitter.  
O sistema realiza: 
